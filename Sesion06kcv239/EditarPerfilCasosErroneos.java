...
public class EditarPerfilCasosErroneos {
  ...
  @Test
  public void testEditarPerfilCasosErroneos() throws Exception {
    ...
    driver.findElement(By.id("Email")).click();
    driver.findElement(By.id("Email")).clear();
    driver.findElement(By.id("Email")).sendKeys("emailnovalido");
    driver.findElement(By.id("Email")).click();
    driver.findElement(By.id("Email")).clear();
    driver.findElement(By.id("Email")).sendKeys("kcv239@inlumine.ual.es");
    driver.findElement(By.id("PhoneNumber")).click();
    driver.findElement(By.id("PhoneNumber")).clear();
    driver.findElement(By.id("PhoneNumber")).sendKeys("numeroerroneo");
